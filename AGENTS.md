...
The core CLI tools are stdlib-only. `mcp_server.py` requires the dependency listed in `requirements.txt`.
...
```
python3 -m ruff check patch_tool.py pr_tool.py file_check_tool.py mcp_server.py
```
...
```
python3 -m py_compile patch_tool.py pr_tool.py file_check_tool.py mcp_server.py
python3 patch_tool.py --help
python3 pr_tool.py --help
python3 file_check_tool.py --help
```
